...
const TeacherDashboard = () => {
  ...
  const upcomingClasses = [
    ...
    { id: 3, subject: 'Computer Science', grade: '11th Grade', time: '02:15 PM', room: 'Computer Lab' },
  ];

  // Mock data for assignments
  const pendingAssignments = [
    { id: 1, title: 'Algebra Quiz', dueDate: 'May 15, 2023', submissions: 18, totalStudents: 25 },
    { id: 2, title: 'Physics Lab Report', dueDate: 'May 18, 2023', submissions: 12, totalStudents: 30 },
    { id: 3, title: 'Programming Project', dueDate: 'May 22, 2023', submissions: 5, totalStudents: 22 },
  ];
