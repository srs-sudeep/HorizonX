		...
		<AuthGuard allowedRoles={[UserRole.ADMIN, UserRole.MANAGER, UserRole.USER]}>
			<Box>
				...
				<Typography variant="subtitle1" color="text.secondary" sx={{ mb: 4 }}>
					Welcome to your personal dashboard. View your tasks and activities
					here.
				</Typography>
					...
					<Grid container spacing={3}>
							...
							<Card>
								...
								<CardContent>
									<Typography variant="body2" color="text.secondary">
										Frontend development for the new customer portal.
										Implementing responsive design and user authentication.
									</Typography>
						...
						<Grid item xs={12} md={6}>
							<Card>
								...
								<CardContent>
									<Typography variant="body2" color="text.secondary">
										API integration with third-party services. Implementing
										secure data exchange and error handling.
									</Typography>
									<Box sx={{ mt: 2, display: "flex", gap: 1 }}>
